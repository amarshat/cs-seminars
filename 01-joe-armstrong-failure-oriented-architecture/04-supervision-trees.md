...
Chapter 3 left an asterisk: restart a process that crashes on a poison input and you get a tight loop, restarting and recrashing forever, doing no work and burning a core. The supervision tree is where that asterisk gets resolved, and it is the single most important detail in this chapter.
