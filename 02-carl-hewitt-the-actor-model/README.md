...
3. **What survived?** The core did: everything is an entity that communicates only by message, addresses are capabilities, and there is no global state. What quietly got replaced is subtle. Hewitt's 1973 actor is side-effect-free and can share a continuation with others. The actor that survived into Erlang and Akka is stateful and serialized. The word stayed; the semantics drifted.
